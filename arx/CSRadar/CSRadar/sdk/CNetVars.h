...
private:
	...
	*/
	DWORD getOffsetRecursive(map_type &map, int acc, const char *name)
	{
	...
	*/
	...
	DWORD getOffsetRecursive(map_type &map, int acc, const char *name, args_t ...args)
	{
...
public:
	...
	CDynamicNetvar(args_t... a)
	{
		...
		off = NetVars.getOffset(a...);
	}
	template<typename... args_t>
	CDynamicNetvar(int offset, args_t... a)
	{
		off = NetVars.getOffset(a...) + offset;
	}
