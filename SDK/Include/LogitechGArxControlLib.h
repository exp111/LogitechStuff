...
bool LogiArxAddContentAs(const void* content, int size, wchar_t * fileName, wchar_t *mimeType);
...
bool LogiArxAddUTF8StringAs(wchar_t* stringContent, wchar_t * fileName, wchar_t *mimeType);
